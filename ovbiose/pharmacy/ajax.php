...
if($action == "save_product2"){
	$save = $crud->save_product2();
	if($save)
		echo $save;
}
...
if($action == "delete_product2"){
	$save = $crud->delete_product2();
	if($save)
		echo $save;
}
...
if($action == "save_receiving2"){
	$save = $crud->save_receiving2();
	if($save)
		echo $save;
}
...
if($action == "delete_receiving2"){
	$save = $crud->delete_receiving2();
	if($save)
		echo $save;
}
...
if($action == "chk_prod_availability2"){
	$save = $crud->chk_prod_availability2();
	if($save)
		echo $save;
}
...
if($action == "save_sales2"){
	$save = $crud->save_sales2();
	if($save)
		echo $save;
}
...
if($action == "save_expired2"){
	$save = $crud->save_expired2();
	if($save)
		echo $save;
}
...
if($action == "delete_expired2"){
	$save = $crud->delete_expired2();
	if($save)
		echo $save;
}